...
<br>
<div>
<form action="TransferBalanceController" onsubmit="return transfer()" method="post">
<table>

<tr>
<td>
Please Enter Reciever's Id : 
</td>
<td> <input type="number" id="recieverId" class="form-control" name="recieverId"></td>
</tr>

<tr>
<td>
Please Enter Balance For Transfer : 
</td>
<td> <input type="number" id="balance" class="form-control" name="balance"></td>
</tr>
<tr><td colspan="2"></td></tr>
<tr>
<td colspan="1"><input type="submit" class="btn btn-primary" value="Tranfer"></td>
<td colspan="1">
