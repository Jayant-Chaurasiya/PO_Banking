...
<br>
<div>
<form action="DepositBalanceController" onsubmit="return deposit()" method="post">
<table>
<tr>
<td>
Please Enter Your Balance To Deposit 
</td>
<td> <input type="number" id="balance" class="form-control" name="balance"></td>
</tr>
<tr><td colspan="2"></td></tr>
<tr>
<td colspan="1"><input type="submit" class="btn btn-primary" value="Deposit"></td>
<td colspan="1">
